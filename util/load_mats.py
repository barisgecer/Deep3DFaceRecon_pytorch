...
def fullBFM09(bfm_folder='BFM'):
    ...
    # save our face model
    savemat(osp.join(bfm_folder, 'BFM_model_full.mat'), {'meanshape': meanshape, 'meantex': meantex, 'idBase': idBase, 'exBase': exBase, 'texBase': texBase,
            'tri': tri, 'point_buf': point_buf, 'tri_mask2': tri_mask2, 'keypoints': keypoints, 'frontmask2_idx': frontmask2_idx, 'skinmask': skinmask})
